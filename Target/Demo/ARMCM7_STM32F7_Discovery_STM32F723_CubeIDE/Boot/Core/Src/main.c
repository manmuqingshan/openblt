...
int main(void)
{
  ...
  MX_USART6_UART_Init();
  /* USER CODE BEGIN 2 */
  /* Initialize the USB HS clock and GPIO pins. */
  HCD_HandleTypeDef usbHandle;
  usbHandle.Instance = USB_OTG_HS;
  HAL_HCD_MspInit(&usbHandle);
...
void MX_USB_OTG_HS_HCD_Init(void)
{
  ...
  /* Note that the USB initialization that follows here is not actually used. The USB
   * disk module handles its initialization.
   */
...
void MX_FMC_Init(void)
{
  ...
  /* Note that the FMC initialization that follows here is not actually used. The display
   * module handles its initialization.
   */
