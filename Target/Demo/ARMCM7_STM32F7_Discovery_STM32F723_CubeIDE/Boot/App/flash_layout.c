/************************************************************************************//**
* \file         Demo/ARMCM7_STM32F7_Discovery_STM32F723_CubeIDE/Boot/App/flash_layout.c
...
{
  /* The STM32F723IE has a different flash sector layout that what is assumed in the
   * STM32F7's port flash driver. Therefore a custom flasyLayout[] table is defined here,
   * which correctly reflects the sectors of the STM32F723IE.
   */
